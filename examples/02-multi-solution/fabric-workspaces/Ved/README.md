# VED solution artifacts

This folder is populated by Microsoft Fabric, not by hand.

Connect the **Ved-Development** workspace to this repository using Fabric Git
integration, with the Git folder set to `/fabric-workspaces/Ved`, then commit its items from
