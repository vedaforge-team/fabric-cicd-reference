# HR solution artifacts

This folder is populated by Microsoft Fabric, not by hand.

Connect the **HR-Development** workspace to this repository using Fabric Git
integration, with the Git folder set to `/fabric-workspaces/HR`, then commit its items from
